...
obj/filaEscalonamento.o: src/filaEscalonamento.c \
                         include/filaEscalonamento.h include/comando.h \
                         include/politicas/fcfs.h include/politicas/roundRobin.h
	$(CC) $(CFLAGS) -c $< -o $@
...
obj/fcfs.o: src/politicas/fcfs.c \
            include/politicas/fcfs.h include/comando.h
	$(CC) $(CFLAGS) -c $< -o $@

obj/roundRobin.o: src/politicas/roundRobin.c \
                  include/politicas/roundRobin.h include/comando.h
	$(CC) $(CFLAGS) -c $< -o $@
